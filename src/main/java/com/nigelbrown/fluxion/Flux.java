...
public class Flux implements Application.ActivityLifecycleCallbacks {
	...
	private static final ConcurrentMap<Class<?>,Set<Method>> REACT_CACHE =
			new ConcurrentHashMap<Class<?>, Set<Method>>();

	/** Cache action methods for each store class. */
	private static final ConcurrentMap<Class<?>, Set<Method>> ACTIONS_CACHE =
			new ConcurrentHashMap<Class<?>, Set<Method>>();
	...
	void registerReactionSubscriber(Class<?> viewClass){
